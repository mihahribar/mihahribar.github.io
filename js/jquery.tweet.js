...
(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["razvijalec"],               // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
    ...
    return this.each(function(){
      ...
      $.getJSON(url, function(data){
        ...
        $.each(data.results, function(i,item){
          ...
          var date = '<p class="time"><a href="http://twitter.com/'+item.from_user+'/statuses/'+item.id+'" title="view tweet on twitter">'+relative_time(item.created_at)+'</a></p>';
